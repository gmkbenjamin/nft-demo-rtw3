      ...
      <div className="w-1/4 flex flex-col ">
        ...
        <div className="flex flex-col y-gap-2 px-2 py-3 bg-slate-100 rounded-b-md h-110 ">
          <div className="">
            ...
            <p className="text-gray-600">Id: {nft.id.tokenId.substr(nft.id.tokenId.length-6)}</p>
            <br/>
            <button value={nft.contract.address} onClick={copyText}><img src='copy-svgrepo-com.svg' width="20" height="20"/></button><p className="text-gray-600">{nft.contract.address.substr(0,4)}....{nft.contract.address.substr(nft.contract.address.length - 4)}</p>
          </div>
